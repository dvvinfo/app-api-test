...
import type { OrderItem, OrderFilters, ApiResponse } from '@/types/api'
...
export const useOrdersStore = defineStore('orders', () => {
  ...
  const fetchOrders = async (page = 1, limit = 10) => {
    ...
    try {
      ...
      const response: ApiResponse<OrderItem> = await ordersApi.getOrders(
        currentFilters,
        page,
        limit,
      )
  ...
  // TODO: Добавить вычисляемые свойства для графиков, когда будет известна структура OrderItem
